...
public class BinaryHeap<T> : ICollection<T> where T : IComparable<T>
{
    ...
    {
        EnsureSort();
        //DADA LA NATURALEZA DE DATA CON DEFAULT_SIZE QUE CONTIENE DATOS A NULL, ESTE MÉTODO DARÁ
        //ERROR SI NO SE TIENE EN CUESTA EL COMPARAR DATOS CON NULL. modificado
